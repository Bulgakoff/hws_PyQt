...
class Asn1Type(Asn1Item):
    """Base class for all classes_for_hw5 representing ASN.1 types.
...
class SimpleAsn1Type(Asn1Type):
    """Base class for all simple classes_for_hw5 representing ASN.1 types.
...
class ConstructedAsn1Type(Asn1Type):
    """Base class for all constructed classes_for_hw5 representing ASN.1 types.
