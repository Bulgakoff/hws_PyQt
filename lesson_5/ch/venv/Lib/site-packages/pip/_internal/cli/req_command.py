"""Contains the Command base classes_for_hw5 that depend on PipSession.

The classes_for_hw5 in this module are in a separate module so the commands not
...
class SessionCommandMixin(CommandContextMixIn):
    ...
    """
    A class mixin for command classes_for_hw5 needing _build_session().
    """
    def __init__(self):
        # type: () -> None
