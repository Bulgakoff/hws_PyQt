...
class QMediaObject(QtCore.QObject):
    ...
    @typing.overload
    def availabilityChanged(
        self, availability: "QMultimedia.AvailabilityStatus"
    ) -> None: ...
    @typing.overload
...
class QCamera(QMediaObject):
    ...
    @typing.overload
    def lockStatusChanged(
        self, a0: "QCamera.LockStatus", a1: "QCamera.LockChangeReason"
    ) -> None: ...
    @typing.overload
    def lockStatusChanged(
        self,
        a0: "QCamera.LockType",
        a1: "QCamera.LockStatus",
        a2: "QCamera.LockChangeReason",
    ) -> None: ...
    def lockFailed(self) -> None: ...
    def locked(self) -> None: ...
    def statusChanged(self, a0: "QCamera.Status") -> None: ...
    def captureModeChanged(
...
class QCameraImageCapture(QtCore.QObject, QMediaBindableInterface):
    ...
    @typing.overload
    def error(
        self, id: int, error: "QCameraImageCapture.Error", errorString: str
    ) -> None: ...
    def mediaObject(self) -> QMediaObject: ...
    def availability(self) -> "QMultimedia.AvailabilityStatus": ...
    def isAvailable(self) -> bool: ...
...
class QCameraLocksControl(QMediaControl):
    ...
    def lockStatusChanged(
        self,
        type: QCamera.LockType,
        status: QCamera.LockStatus,
        reason: QCamera.LockChangeReason,
    ) -> None: ...
    def unlock(
        self, locks: typing.Union[QCamera.LockTypes, QCamera.LockType]
    ) -> None: ...
...
class QMediaResource(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, request: QtNetwork.QNetworkRequest, mimeType: str = ...
    ) -> None: ...
    @typing.overload
