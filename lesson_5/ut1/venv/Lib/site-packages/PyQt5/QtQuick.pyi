...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    def mapRectFromItem(
        self, item: "QQuickItem", rect: QtCore.QRectF
    ) -> QtCore.QRectF: ...
    def mapFromScene(
        self, point: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> QtCore.QPointF: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    def sceneGraphError(
        self, error: "QQuickWindow.SceneGraphError", message: str
    ) -> None: ...
...
class QSGImageNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, a0: "QSGImageNode.TextureCoordinatesTransformMode"
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
...
class QSGMaterialShader(PyQt5.sip.wrapper):
    class RenderState(sip.simplewrapper):
        ...
        class DirtyStates(sip.simplewrapper):
            ...
            @typing.overload
            def __init__(
                self, a0: "QSGMaterialShader.RenderState.DirtyStates"
            ) -> None: ...
            def __hash__(self) -> int: ...
            def __bool__(self) -> int: ...
...
class QSGRendererInterface(sip.simplewrapper):
    ...
    class ShaderCompilationTypes(sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, a0: "QSGRendererInterface.ShaderCompilationTypes"
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
