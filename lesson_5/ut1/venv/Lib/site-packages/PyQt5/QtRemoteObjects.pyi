...
class QRemoteObjectReplica(QtCore.QObject):
    ...
    def stateChanged(
        self,
        state: "QRemoteObjectReplica.State",
        oldState: "QRemoteObjectReplica.State",
    ) -> None: ...
    def initialized(self) -> None: ...
...
class QRemoteObjectNode(QtCore.QObject):
    ...
    def remoteObjectRemoved(
        self, a0: typing.Tuple[str, "QRemoteObjectSourceLocationInfo"]
    ) -> None: ...
    def remoteObjectAdded(
        self, a0: typing.Tuple[str, "QRemoteObjectSourceLocationInfo"]
    ) -> None: ...
...
class QRemoteObjectRegistry(QRemoteObjectReplica):
    def remoteObjectRemoved(
        self, entry: typing.Tuple[str, "QRemoteObjectSourceLocationInfo"]
    ) -> None: ...
    def remoteObjectAdded(
        self, entry: typing.Tuple[str, "QRemoteObjectSourceLocationInfo"]
    ) -> None: ...
