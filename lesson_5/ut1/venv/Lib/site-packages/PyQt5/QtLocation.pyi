...
class QGeoCodingManager(QtCore.QObject):
    def error(
        self, reply: QGeoCodeReply, error: QGeoCodeReply.Error, errorString: str = ...
    ) -> None: ...
...
class QGeoRoutingManager(QtCore.QObject):
    def error(
        self, reply: QGeoRouteReply, error: QGeoRouteReply.Error, errorString: str = ...
    ) -> None: ...
...
class QPlaceManager(QtCore.QObject):
    ...
    def error(
        self, a0: QPlaceReply, error: QPlaceReply.Error, errorString: str = ...
    ) -> None: ...
...
class QPlaceManagerEngine(QtCore.QObject):
    ...
    def categoryUpdated(
        self, category: QPlaceCategory, parentCategoryId: str
    ) -> None: ...
    def categoryAdded(
        self, category: QPlaceCategory, parentCategoryId: str
    ) -> None: ...
