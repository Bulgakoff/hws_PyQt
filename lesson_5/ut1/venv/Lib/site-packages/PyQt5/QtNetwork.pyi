...
class QAbstractSocket(QtCore.QIODevice):
    ...
    def proxyAuthenticationRequired(
        self, proxy: "QNetworkProxy", authenticator: "QAuthenticator"
    ) -> None: ...
...
class QNetworkAccessManager(QtCore.QObject):
    ...
    def preSharedKeyAuthenticationRequired(
        self, reply: "QNetworkReply", authenticator: "QSslPreSharedKeyAuthenticator"
    ) -> None: ...
    def networkAccessibleChanged(
        self, accessible: "QNetworkAccessManager.NetworkAccessibility"
    ) -> None: ...
    def sslErrors(
        self, reply: "QNetworkReply", errors: typing.Iterable["QSslError"]
    ) -> None: ...
...
class QNetworkSession(QtCore.QObject):
    ...
    def usagePoliciesChanged(
        self,
        usagePolicies: typing.Union[
            "QNetworkSession.UsagePolicies", "QNetworkSession.UsagePolicy"
        ],
    ) -> None: ...
    ...
    def preferredConfigurationChanged(
        self, config: QNetworkConfiguration, isSeamless: bool
    ) -> None: ...
...
class QSslSocket(QTcpSocket):
    ...
    def setLocalCertificate(
        self, path: str, format: QSsl.EncodingFormat = ...
    ) -> None: ...
    def abort(self) -> None: ...
    def flush(self) -> bool: ...
    def atEnd(self) -> bool: ...
