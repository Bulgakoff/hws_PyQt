...
def define(
    ...
    *,
    ...
    and that mutable classes_for_hw5 (``frozen=False``) validate on ``__setattr__``.
    ...
    def wrap(cls):
        ...
        We also ensure that frozen-ness of classes_for_hw5 is inherited.
        """
        nonlocal frozen, on_setattr

        had_on_setattr = on_setattr not in (None, setters.NO_OP)

        # By default, mutable classes_for_hw5 validate on setattr.
        ...
        for base_cls in cls.__bases__:
            if base_cls.__setattr__ is _frozen_setattrs:
                if had_on_setattr:
                    raise ValueError(
                        "Frozen classes_for_hw5 can't use on_setattr "
