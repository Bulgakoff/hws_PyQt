...
ic(" -- Изменим книгу в библиотеке --")
ic(book_3.Title, book_3.BookId)
...
ic("Session.dirty:", session.dirty)
session.commit()
...
ic(" -- Удалим книгу из библиотеки --")
ic(book_2.Title, book_2.BookId)
...
ic("Session.deleted:", session.deleted)
session.commit()
